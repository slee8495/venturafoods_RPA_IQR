...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.14.2025.xlsx",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.14.2025.xlsx",
          overwrite = TRUE)
...
# macro_platform ----
macro_platform <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.14.2025.xlsx",
...
receipt <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/01142025/PO1.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/BI Forecast Backup/2025/DSX Forecast Backup - 2025.01.13.xlsx") ### Match with BoM date! ####
...
inventory <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2025.01.14.xlsx",
                        sheet = "FG")
...
IQR_FG_sample <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.14.2025.xlsx",
                            sheet = "Location FG")
...
sdcv <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/01142025/Ordered and Shipped History (Ordered) - Month - 01.14.2025.xlsx")
...
# pre_data
pre_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.07.2025/iqr_fg_rstudio_01072025.xlsx")
...
completed_sku_list_2 <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/01142025/Complete SKU list - Linda.xlsx")
...
exception_report_dou <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/JDE DNRR Exception report extract/2025/exception report DOU 2025.01.14.xlsx")
...
# Arrange ----
fg_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.14.2025.xlsx",
                                  sheet = "Location FG")
...
writexl::write_xlsx(IQR_FG_sample, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/iqr_fg_rstudio_01142025.xlsx")
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2025/01.14.2025/Inventory Health (IQR) Tracker - DOS.xlsx",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Inventory Health (IQR) Tracker - DOS.xlsx")



#### IQR main file Moving to S Drive. 
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.14.2025.xlsx",
          "S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.14.2025.xlsx",
          overwrite = TRUE)



### DOS Tracker moving to S Drive
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Inventory Health (IQR) Tracker - DOS.xlsx",
...
file.copy("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.07.2025.xlsx",
          "S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/IQR Historical Data Collection/FG/2025/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.07.2025.xlsx",
          overwrite = TRUE)
...
pre_month_actual <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Actual Shipped.xlsx")
