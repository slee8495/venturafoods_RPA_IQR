...
po <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 03.22.23.xlsx", 
...
receipt <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 03.22.23.xlsx", 
...
wo <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 03.22.23.xlsx", 
...
custord <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 03.22.23.xlsx", 
...
loc_624_custord <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Canada open order - 03.22.23.xlsx", 
                              col_names = FALSE)
...
DSX_Forecast_Backup_pre <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.02.02.xlsx")
...
# Read FG ----
Inventory_analysis_FG <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations - 03.22.23.xlsx", 
                                    sheet = "FG")
...
IQR_FG_sample <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) - 03.01.23 - 2.xlsx",
...
sdcv <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Standard Deviation & CV/Standard Deviation, CV,  February 2023.xlsx")
...
IQR_FG_sample %<>% 
  dplyr::mutate(Forward_Inv_Target_Current_Month_Fcst = (pmax((Current_Month_Fcst / 23) * OPV, JDE_MOQ)) / 2 + Current_SS,
