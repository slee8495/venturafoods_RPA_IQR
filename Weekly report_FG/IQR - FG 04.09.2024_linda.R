...
# macro_platform ----
macro_platform <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 04.09.2024.xlsx",
...
exception_report <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/JDE Exception report extract/2024/exception report 2024.04.09.xlsx", 
                               sheet = "Sheet1",
...
wo <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/04.09/wo.csv",
               header = FALSE)
...
IQR_FG_sample <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 04.09.2024.xlsx",
                            sheet = "Location FG")
...
######## added 7/5/2023 #########
# wo_2
wo_2 <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/04.09/wo.csv",
                 header = FALSE)
...
# receipt_2
receipt_2 <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/04.09/receipt.csv",
                      header = FALSE)
...
# pre_data
pre_data <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/IQR/iqr_fg_rstudio_04092024.xlsx")
...
# Arrange ----
fg_data_for_arrange <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 04.09.2024.xlsx",
                                  sheet = "Location FG")
...
writexl::write_xlsx(IQR_FG_sample, "C:/Users/lliang/OneDrive - Ventura Foods/R Studio/IQR/iqr_fg_rstudio_04092024.xlsx")
writexl::write_xlsx(custord_open_order, "C:/Users/lliang/OneDrive - Ventura Foods/R Studio/IQR/Open Order.xlsx")
