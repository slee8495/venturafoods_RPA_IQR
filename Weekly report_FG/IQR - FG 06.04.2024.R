...
dir.create("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024")

file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/05.28.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 05.28.2024.xlsx",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 06.04.2024.xlsx",
          overwrite = TRUE)
...
# macro_platform ----
macro_platform <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 06.04.2024.xlsx",
...
po <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/06.04.2024/Copy of PO Reporting Tool - 06.03.24.xlsx",
                 sheet = "Daily Open PO")
...
DSX_Forecast_Backup_pre <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/BI Forecast Backup/2024/DSX Forecast Backup - 2024.05.01.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/BI Forecast Backup/2024/DSX Forecast Backup - 2024.06.03.xlsx") ### Match with BoM date! ####
...
inventory <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/06.04.2024/Inventory.xlsx",
                        sheet = "FG")
...
IQR_FG_sample <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 06.04.2024.xlsx",
                            sheet = "Location FG")
...
sdcv <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Standard Deviation & CV/Standard Deviation, CV,  May 2024.xlsx")
...
# pre_data
pre_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/05.28.2024/iqr_fg_rstudio_05282024.xlsx")
...
exception_report_dou <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/06.04.2024/exception report dnrr.xlsx")
...
IQR_FG_sample %>% 
  dplyr::select(-planner, -planner_name) %>%
  dplyr::left_join(exception_report_dou) %>% 
  dplyr::mutate(planner = ifelse(is.na(planner), "DNRR", planner)) %>% 
  dplyr::left_join(Planner_address %>% rename(planner_name = Alpha_Name)) %>% 
  dplyr::mutate(planner_name = ifelse(planner == "DNRR", "DNRR", planner_name)) -> IQR_FG_sample
...
# Arrange ----
fg_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 06.04.2024.xlsx",
                                  sheet = "Location FG")
...
writexl::write_xlsx(IQR_FG_sample, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/iqr_fg_rstudio_06042024.xlsx")
writexl::write_xlsx(custord_open_order, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Open Order.xlsx")
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/06.04.2024/Inventory Health (IQR) Tracker - DOS.xlsx",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Inventory Health (IQR) Tracker - DOS.xlsx")



#### IQR main file Moving to S Drive. 
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 06.04.2024.xlsx",
          "S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 06.04.2024.xlsx",
          overwrite = TRUE)



### DOS Tracker moving to S Drive
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Inventory Health (IQR) Tracker - DOS.xlsx",
...
file.copy("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 05.28.2024.xlsx",
          "S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/IQR Historical Data Collection/FG/2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 05.28.2024.xlsx",
          overwrite = TRUE)
...
pre_month_actual <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/06.04.2024/Actual Shipped.xlsx")
