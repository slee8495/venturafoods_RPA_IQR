...
# macro_platform ----
macro_platform <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/9.27.2023/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 09.27.23.xlsx",
...
loc_624_custord <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/9.26.2023/Canada Open Orders.xlsx", 
                              col_names = FALSE)
...
DSX_Forecast_Backup_pre <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.08.01.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.09.26.xlsx") ### Match with BoM date! ####
...
# Read FG ----
Inventory_analysis_FG <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/9.26.23/Inventory Report for all locations (FG).xlsx")
...
IQR_FG_sample <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/9.27.2023/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 09.27.23.xlsx",
                            sheet = "Location FG")
...
# pre_data
pre_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/9.21.2023/IQR_FG_Report_092123.xlsx")
...
# Arrange ----
fg_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/9.27.2023/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 09.27.23.xlsx",
                                  sheet = "Location FG")
...
writexl::write_xlsx(IQR_FG_sample, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/9.27.2023/IQR_FG_Report_092723.xlsx")
writexl::write_xlsx(custord_open_order, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/9.27.2023/Open Order.xlsx")
