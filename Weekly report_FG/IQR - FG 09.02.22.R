...
loc_624_custord <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Canada open order - 09.02.22.xlsx", 
                              col_names = FALSE)
...
# Read FG ----
Inventory_analysis_FG <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations - 09.02.22.xlsx", 
                                    sheet = "FG")
...
IQR_FG_sample <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) - 08.29.22.xlsx",
