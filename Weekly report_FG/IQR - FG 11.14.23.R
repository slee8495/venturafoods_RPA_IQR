...
# macro_platform ----
macro_platform <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/11.07.2023/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 11.07.23.xlsx",
...
Campus_ref %>% 
  dplyr::mutate(B_P = Location) -> Campus_ref
...
loc_624_custord <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/11.14.2023/Canada Open Orders.xlsx", 
                              col_names = FALSE)
...
loc_39_bt %>% 
  ...
  dplyr::mutate(in_next_7_days = ifelse(date < Sys.Date() + 7, "Y", "N"),
                in_next_14_days = ifelse(date < Sys.Date() + 14, "Y", "N"),
                in_next_21_days = ifelse(date < Sys.Date() + 21, "Y", "N"),
                in_next_28_days = ifelse(date < Sys.Date() + 28, "Y", "N")) -> loc_39_bt_2
...
# (Path Revision Needed) DSX Forecast pulling (Previous month file)---- Change Directory ---- Lag 1

DSX_Forecast_Backup_pre <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.10.02.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.11.14.xlsx") ### Match with BoM date! ####
...
# Read FG ----
Inventory_analysis_FG <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/11.14.23/FG_2.xlsx")
...
Inventory_analysis_FG %>% 
  ...
  dplyr::mutate(current_inventory_balance = ifelse(is.na(current_inventory_balance), 0, current_inventory_balance),
                product_label_sku = gsub("-", "", product_label_sku)) %>% 
  dplyr::filter(product_label_sku != "'1") %>% 
  dplyr::left_join(Campus_ref %>% select(Location, Campus) %>% rename(location = Location, campus = Campus) %>% mutate(location = as.double(location))) %>% 
  ...
  dplyr::rename(Location = location,
                ...
                Inventory_Hold_Status = inventory_hold_status,
                Inventory_Qty_Cases = current_inventory_balance) %>% 
  dplyr::relocate(ref, campus_ref, Location, Location_Nm, campus, SKU, Description, Inventory_Status) -> Inventory_analysis_FG
...
IQR_FG_sample <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/11.14.2023/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 11.14.23.xlsx",
                            sheet = "Location FG")
...
sdcv <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Standard Deviation & CV/Standard Deviation, CV,  November 2023.xlsx")
...
######## added 7/5/2023 #########
# wo_2
wo_2 <- read.csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/DSXIE/2023/11.14/wo.csv",
                 header = FALSE)
...
# receipt_2
receipt_2 <- read.csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/DSXIE/2023/11.14/receipt.csv",
                      header = FALSE)
...
# pre_data
pre_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/11.07.2023/IQR_FG_Report_110723.xlsx")
...
# Arrange ----
fg_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/11.14.2023/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 11.14.23.xlsx",
                                  sheet = "Location FG")
...
writexl::write_xlsx(IQR_FG_sample, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/11.14.2023/IQR_FG_Report_111423.xlsx")
writexl::write_xlsx(custord_open_order, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/11.14.2023/Open Order.xlsx")
...
pre_month_actual <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/11.07.2023/Actual Shipped.xlsx")
