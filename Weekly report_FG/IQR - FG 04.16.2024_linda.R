...
# macro_platform ----
macro_platform <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 04.16.2024.xlsx",
...
wo <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/04.16/wo.csv",
               header = FALSE)
...
custord <- read.xlsx("S:/Supply Chain Projects/Linda Liang/reference files/US and CAN OO BT where status _ J.xlsx",
                     colNames = FALSE)
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/BI Forecast Backup/2024/DSX Forecast Backup - 2024.04.15.xlsx") ### Match with BoM date! ####
...
IQR_FG_sample <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 04.16.2024.xlsx",
                            sheet = "Location FG")
...
######## added 7/5/2023 #########
# wo_2
wo_2 <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/04.16/wo.csv",
                 header = FALSE)
...
# receipt_2
receipt_2 <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/04.16/receipt.csv",
                      header = FALSE)
...
# Arrange ----
fg_data_for_arrange <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 04.16.2024.xlsx",
                                  sheet = "Location FG")
...
writexl::write_xlsx(IQR_FG_sample, "C:/Users/lliang/OneDrive - Ventura Foods/R Studio/IQR/iqr_fg_rstudio_04162024.xlsx")
