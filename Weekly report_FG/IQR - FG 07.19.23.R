...
per_pallet <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/7.19.2023/FG Cases per Pallet (2).xlsx")
per_pallet %>% 
  janitor::clean_names() %>% 
...
loc_624_custord <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/7.19.2023/Canada Open Orders (15).xlsx", 
                              col_names = FALSE)
...
# Read FG ----
Inventory_analysis_FG <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/7.19.2023/Inventory Report for all locations (32).xlsx")
...
IQR_FG_sample <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) - 07.12.23.xlsx",
...
# pre_data
pre_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/7.12.2023/IQR_FG_Report_071223.xlsx")
...
# Arrange ----
fg_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/7.19.2023/Finished Goods Inventory Health Adjusted Forward (IQR) - 07.19.23.xlsx",
                                  sheet = "FG without BKO BKM TST")
...
writexl::write_xlsx(IQR_FG_sample, "IQR_FG_report_071923.xlsx")


file.rename(from="C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/IQR/venturafoods_RPA_IQR/IQR_FG_report_071923.xlsx",
            to="C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/7.19.2023/IQR_FG_Report_071923.xlsx")


file.rename(from="C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/IQR/venturafoods_RPA_IQR/wo.xlsx",
            to="C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/7.19.2023/wo.xlsx")

file.rename(from="C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/IQR/venturafoods_RPA_IQR/receipt.xlsx",
            to="C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/7.19.2023/receipt.xlsx")
