...
planner_adress <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Address Book - 06.05.23.xlsx", 
...
rm_data <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 05.31.23.xlsx", 
...
inventory_analysis_rm <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.7.2023/Inventory Report for all locations (23).xlsx")
...
# BoM_dep_demand ----
bom_dep_demand <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.7.2023/Bill of Material_060723.xlsx",
                             sheet = "Sheet1")
...
ss_optimization <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/SS Optimization by Location - Raw Material May 2023.xlsx",
                              sheet = "Sheet1")
...
inv_bal <- read_csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/6.7.23/ATT73079.csv")
...
# Arrange ----
rm_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/5.31.23/Raw Material Inventory Health (IQR) - 05.31.23.xlsx",
                                  sheet = "RM data")
...
rm_data %>% 
  dplyr::mutate(loc_sku = gsub("_", "-", loc_sku)) %>% 
  dplyr::relocate(mfg_loc, loc_name, item, loc_sku, supplier_number, description, used_in_priority_sku, class, item_type, shelf_life_day,
...
writexl::write_xlsx(rm_data, "IQR_RM_Report_060723.xlsx")


file.rename(from="C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/IQR/venturafoods_RPA_IQR/IQR_RM_Report_060723.xlsx",
            to="C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/6.7.23/IQR_RM_Report_060723.xlsx")
