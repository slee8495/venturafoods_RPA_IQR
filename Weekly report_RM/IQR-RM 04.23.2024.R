...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.16.2024/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.16.2024.xlsx",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.23.2024/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.23.2024.xlsx",
          overwrite = TRUE)
...
consumption_data <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Raw Material Monthly Consumption - 2024.03.18.xlsx")
...
rm_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.23.2024/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.23.2024.xlsx", 
...
############ Inventory
inventory <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.04.23.xlsx",
                        sheet = "RM")
...
jde_inv_for_25_55_label <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/JDE Inventory Lot Detail - 2024.04.23.xlsx")
...
# BoM_dep_demand ----
bom_dep_demand <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/04.23.2024/Bill of Material_042324.xlsx",
                             sheet = "Sheet1")
...
# Lot At Risk $
rm_at_risk_file <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.23.2024/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.23.2024.xlsx",
...
rm_data %>% 
  dplyr::select(-description) %>% 
  dplyr::left_join(consumption_data %>% select(item, na_3) %>% rename(description = na_3) %>% distinct(item, description), by = "item") -> rm_data
...
# Arrange ----
rm_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.23.2024/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.23.2024.xlsx",
                                  sheet = "RM data")
...
writexl::write_xlsx(rm_data, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.23.2024/iqr_rm_rstudio_042324.xlsx")
...
writexl::write_xlsx(bom, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.23.2024/bom.xlsx")


#### DOS File Moving from pre week FG. 
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/04.16.2024/Inventory Health (IQR) Tracker - DOS.xlsx",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.23.2024/Inventory Health (IQR) Tracker - DOS.xlsx",
          overwrite = TRUE)
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/04.23.2024/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.23.2024.xlsx",
          "S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.23.2024.xlsx",
          overwrite = TRUE)

#### IQR main pre-week file Moving in S Drive. 
file.copy("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.16.2024.xlsx",
