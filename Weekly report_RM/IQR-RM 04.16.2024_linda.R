...
rm_data <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.16.2024.xlsx", 
...
############ Inventory
inventory <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.04.16.xlsx",
                        sheet = "RM")
...
# BoM_dep_demand ----
bom_dep_demand <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/BOM/raw files with JDE BOM report/Bill of Material_041624.xlsx",
                             sheet = "Sheet1")
...
# Custord PO ----
po <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/04.16/po.csv",
               header = FALSE)
...
# Custord Receipt ----
receipt <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/04.16/receipt.csv",
                    header = FALSE)
...
# Lot At Risk $
rm_at_risk_file <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.16.2024.xlsx",
...
bom <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/JDE BoM/2024/JDE BoM 04.16.2024.xlsx",
                  sheet = "BoM")
...
# Arrange ----
rm_data_for_arrange <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 04.16.2024.xlsx",
                                  sheet = "RM data")
...
writexl::write_xlsx(rm_data, "C:/Users/lliang/OneDrive - Ventura Foods/R Studio/IQR/iqr_rm_rstudio_041624.xlsx")
