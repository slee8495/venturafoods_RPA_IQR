...
planner_adress <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Address Book - 04.03.23.xlsx", 
...
rm_data <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 04.12.23.xlsx", 
...
inventory_analysis_rm <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/4.26.2023/Inventory Report for all locations.xlsx", 
                                    sheet = "RM")
...
# BoM_dep_demand ----
bom_dep_demand <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/4.26.2023/Bill of Material.xlsx",
                             sheet = "Sheet1")
...
consumption_data <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/consumption data component - 04.04.23.xlsx")
...
ss_optimization <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/SS Optimization by Location - Raw Material April 2023.xlsx",
                              sheet = "Sheet1")
...
# Custord PO ----
po <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/4.26.2023/custord po wo receipt.xlsx", 
...
# Custord Receipt ----
receipt <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/4.26.2023/custord po wo receipt.xlsx", 
