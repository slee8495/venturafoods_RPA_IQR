...
planner_adress <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Address Book - 2023.12.04.xlsx", 
...
rm_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/12.19.23/Raw Material Inventory Health (IQR) NEW TEMPLATE - 12.19.23.xlsx", 
...
# BoM_dep_demand ----
bom_dep_demand <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/12.19.2023/Bill of Material_121923.xlsx",
                             sheet = "Sheet1")
...
# Consumption data component # Updated once a month ---- (You might want to double check if ref col is already created)
consumption_data <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Raw Material Monthly Consumption - 2023.12.13.xlsx")
...
inv_bal <- read_csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/12.19.23/inv_bal.csv")
...
# Lot At Risk $
rm_at_risk_file <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/12.19.23/Raw Material Inventory Health (IQR) NEW TEMPLATE - 12.19.23.xlsx",
...
# Arrange ----
rm_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/12.19.23/Raw Material Inventory Health (IQR) NEW TEMPLATE - 12.19.23.xlsx",
                                  sheet = "RM data")
...
writexl::write_xlsx(rm_data, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/12.19.23/iqr_rm_rstudio_121923.xlsx")
...
writexl::write_xlsx(bom, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/12.19.23/bom.xlsx")
...
monthly_consumption <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/11.07.23/Raw Material Monthly Consumption.xlsx")
...
monthly_consumption %>% 
  ...
  dplyr::left_join(campus_ref %>% select(campus, location)) %>% 
