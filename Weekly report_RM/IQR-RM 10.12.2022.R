...
rm_data <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 10.05.22-2.xlsx", 
...
inventory_analysis_rm <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations - 10.12.22.xlsx", 
                                    sheet = "RM")
...
ss_optimization <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/Desktop/SS Optimization by Location - Raw Material October 2022.xlsx",
                              sheet = "Sheet1")
...
writexl::write_xlsx(rm_data, "IQR_RM_10.12.2022.xlsx")
