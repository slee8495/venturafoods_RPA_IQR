...
rm_data <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 06.14.23.xlsx", 
...
inventory_analysis_rm <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations RM - 06.21.23.xlsx")
...
inv_bal <- read_csv("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/ATT70124.csv")
...
# Arrange ----
rm_data_for_arrange <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 06.14.23.xlsx",
                                  sheet = "RM data")
...
writexl::write_xlsx(rm_data, "IQR_RM_Report_062123.xlsx")
