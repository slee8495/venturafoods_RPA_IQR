...
rm_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/10.25.23/Raw Material Inventory Health (IQR) NEW TEMPLATE - 10.25.23.xlsx", 
...
inventory_analysis_rm <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/10.24.23/Inventory Report for all locations (RM).xlsx")
...
# BoM_dep_demand ----
bom_dep_demand <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/10.24.2023/Bill of Material_102423.xlsx",
                             sheet = "Sheet1")
...
inv_bal <- read_csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/10.24.23/ATT72938.csv")
...
# Lot At Risk $
rm_at_risk_file <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/10.25.23/Raw Material Inventory Health (IQR) NEW TEMPLATE - 10.25.23.xlsx",
...
# Arrange ----
rm_data_for_arrange <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/10.25.23/Raw Material Inventory Health (IQR) NEW TEMPLATE - 10.25.23.xlsx",
                                  sheet = "RM data")
...
writexl::write_xlsx(rm_data, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/10.25.23/IQR_RM_Report_102523.xlsx")
