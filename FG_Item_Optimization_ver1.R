...
#write.xlsx(final_data_fg,"Final_data_fg.xlsx")
final_data_fg = read.xlsx("Final_data_fg.xlsx")
# Final touch
final_data_fg %>% 
  dplyr::filter(!str_detect(item, "BKO|BKM|TST|^1$")) %>%
  #dplyr::filter(!str_detect(item, "BKO|BKM|TST|^1$")) -> final_data_fg
  #dplyr::filter(!(location %in% c("16", "22", "502", "503", "690", "691", "214", "331", "601", "602", "608", "621", "636", "660", "675"))) %>% 
  dplyr::filter(!(location %in% c("16", "22", "502", "503", "690", "691", "214", "331", "601", "602", "608", "621", "636", "660", "675")))-> final_data_fg
...
writexl::write_xlsx(final_data_fg, "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/FG/Weekly Run Files/2025/02.04.2025/fg_optimization.xlsx")
