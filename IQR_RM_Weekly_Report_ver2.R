...
file.copy("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/01.21.2025/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.28.2025.xlsx",
          "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/01.28.2025/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.28.2025.xlsx",
          overwrite = TRUE)
...
rm_data <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/01.28.2025/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.28.2025.xlsx", 
...
# BoM_dep_demand ----
bom_dep_demand <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/01282025/Bill of Material_01282025.xlsx",
                             sheet = "Sheet1")
...
# Lot At Risk $
rm_at_risk_file <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/01.28.2025/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.28.2025.xlsx",
...
bom <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/JDE BoM/2025/JDE BoM 01.28.2025.xlsx",
                  sheet = "BoM")
...
# Arrange ----
rm_data_for_arrange <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/01.28.2025/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.28.2025.xlsx",
                                  sheet = "RM data")
...
writexl::write_xlsx(rm_data, "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/01.28.2025/iqr_rm_rstudio_01282025.xlsx")





writexl::write_xlsx(bom, "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/01.28.2025/bom.xlsx")
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2025/01.14.2025/Inventory Health (IQR) Tracker - DOS.xlsx",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2025/01.28.2025/Inventory Health (IQR) Tracker - DOS.xlsx",
          overwrite = TRUE)
...
file.copy("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Report run/2025/01.28.2025/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.28.2025.xlsx",
          "S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.28.2025.xlsx",
          overwrite = TRUE)

#### IQR main pre-week file Moving in S Drive. 
file.copy("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.21.2025.xlsx",
          "S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/IQR Historical Data Collection/RM/Raw Material Inventory Health (IQR) NEW TEMPLATE - 01.21.2025.xlsx",
          overwrite = TRUE)
...
monthly_consumption <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/01.28.2025/Raw Material Monthly Consumption.xlsx")
