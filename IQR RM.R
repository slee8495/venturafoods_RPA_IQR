...
Inventory_analysis_RM <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Test/Inventory Analysis 05.18.22.xlsx", 
                                    col_types = c("text", "text", "text", 
                                                  "text", "text", "text", "text", "numeric", 
                                                  "numeric", "numeric"),
                                    sheet = "RM")
...
colnames(Inventory_analysis_RM)[3] <- "SKU"
colnames(Inventory_analysis_RM)[4] <- "Label"
...
colnames(Inventory_analysis_RM)[8] <- "Last_Purchase_Price"
colnames(Inventory_analysis_RM)[9] <- "Total_Cost"
colnames(Inventory_analysis_RM)[10] <- "Inventory_Qty_Cases"
...
# BoM_dep_demand ----
BoM_dep_demand <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Test/BOM_Detail Constrained RM - 05.18.22.xlsx",
                             sheet = "dep demand")
...
# Custord PO ----
po <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Test/wo receipt custord po - 05.18.22.xlsx", 
...
# Custord Receipt ----
receipt <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Test/wo receipt custord po - 05.18.22.xlsx", 
...
writexl::write_xlsx(RM_data, "IQR_Report_5.13.2022.xlsx")
